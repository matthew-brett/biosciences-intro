...
This means we can count the numbe of TRUE values in a sequence by using the function `sum`, which adds all the values in a sequence:
...
## On some data that fits the t-test assumptions
